...
class CFG:
    ...
    MODEL_CHECKPOINT_DIR = os.path.join('output2', 'checkpoints', 'kannada_densenet121_attention621')
    MODEL_CHECKPOINT_FILE = os.path.join(MODEL_CHECKPOINT_DIR, 'kannada_densenet121_attention621_best.pth')
...
if __name__ == "__main__":
    ...
    IMAGE_TO_PREDICT = "../../test/k59.jpeg"
