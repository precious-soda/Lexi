...
class MainCFG:
    ...
    SEED = 42
    MODEL_CHECKPOINT_DIR = os.path.join('models', 'main', 'checkpoints', 'kannada_densenet121_attention')
...
class OttaksharaCFG:
    ...
    DEVICE = torch.device("cuda" if torch.cuda.is_available() else "cpu")
    SEED = 42
    MODEL_CHECKPOINT_DIR = os.path.join('models','ottaksharas','checkpoints', 'kannada_densenet121_attention')
    MODEL_CHECKPOINT_FILE = os.path.join(MODEL_CHECKPOINT_DIR, 'kannada_densenet121_attention_best.pth')
